...
def showimage():
    ...
    filename=filedialog.askopenfilename(initialdir=os.getcwd(),
                                        title='Select img',filetype=(('PNG file','*.png'),
                                                                     ('JPG file','*.jpg'),
                                                                     ("ALL file",'*.txt')))
...
root=Tk()
root.title("Színfelismerő program")
...
Button(selectimage,text="Kép kiválasztás",width=12,height=1,font="arial 14 bold",command=showimage).place(x=10,y=300)
Button(selectimage,text="Színkeresés",width=12,height=1,font="arial 14 bold",command=Findcolor).place(x=176,y=300)
